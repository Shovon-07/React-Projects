...
// const SecurityProvider = ({ children }) => {
//   // const baseUrl = `${
//   //   import.meta.env.VITE_APP_SECURITY_URL
...
//   //     domain: "Radian agrovet",
//   //     token: "!@Sh@v@n@7$EX->Rit&Pri&Shem",
//   //   };
//   //   await axios
//   //     .post(`${baseUrl}`, payload)
//   //     .then((res) => {
//   //       if (
//   //         res.data.data[0]._id == "67a1e78c9552ba5952729b8d" &&
//   //         res.data.data[0].token == "!@Sh@v@n@7$EX->Rit&Pri&Shem" &&
//   //         res.data.status
//   //       ) {
//   //         setIsBlocked(res.data.data[0].is_blocked);
//   //         console.log("Secured");
//   //       } else {
//   //         console.log(res);
//   //       }
...
//       socket.on("security-status", (data) => {
//         setIsBlocked(data[0].is_blocked);
//         console.log(data[0], " from server");
//       });
//     });
